                    ...
                    <IonCard button className="lightShadow">
                        ...
                        >
                            <IonRow className="border-bottom-row">
                                <IonCol
                                    size={MyBookingParam?.status == "PEND" ? "9" : "6"}
                                >
                                ...
                                >
                                    ...
                                    <IonRow className="ion-justify-content-center">
                                        <IonText className="booking-container-status">BOOKED</IonText>
                                    </IonRow>
                                </IonCol>
                                ...
                                >
                                    ...
                                    <IonRow className="ion-justify-content-center">
                                        <IonText className="booking-container-status">IN YARD</IonText>
                                    </IonRow>
                                </IonCol>
